...
#
# Generated by Vivado on Sat Jan 08 20:05:04 CST 2022
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: design_ps_pl.sh [-help]
# usage: design_ps_pl.sh [-lib_map_path]
# usage: design_ps_pl.sh [-noclean_files]
# usage: design_ps_pl.sh [-reset_run]
#
...
# executing this script. Please type 'design_ps_pl.sh -help' for more information.
#
...
# Script info
echo -e "design_ps_pl.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_processing_system7_0_0/sim/design_ps_pl_processing_system7_0_0.v" \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_half_adder_0_0/sim/design_ps_pl_half_adder_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_axi_gpio_0_0/sim/design_ps_pl_axi_gpio_0_0.vhd" \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_axi_gpio_1_0/sim/design_ps_pl_axi_gpio_1_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_rst_processing_system7_0_100M_0/sim/design_ps_pl_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_xbar_0/sim/design_ps_pl_xbar_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/design_ps_pl/ip/design_ps_pl_auto_pc_0/sim/design_ps_pl_auto_pc_0.v" \
    "$ref_dir/../../../bd/design_ps_pl/hdl/design_ps_pl.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design_ps_pl xil_defaultlib.glbl -o design_ps_pl_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design_ps_pl_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./design_ps_pl.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key design_ps_pl_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc design_ps_pl_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./design_ps_pl.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: design_ps_pl.sh [-help]\n\
Usage: design_ps_pl.sh [-lib_map_path]\n\
Usage: design_ps_pl.sh [-reset_run]\n\
Usage: design_ps_pl.sh [-noclean_files]\n\n\
