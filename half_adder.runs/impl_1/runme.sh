...
HD_PWD='/home/lorenzogomez/half_adder/half_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ps_pl_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_ps_pl_wrapper.tcl -notrace
