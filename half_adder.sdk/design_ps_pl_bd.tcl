...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_net -net a_1 [get_bd_ports a] [get_bd_pins half_adder_0/a]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_ports carry] [get_bd_pins axi_gpio_1/gpio2_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports sum] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins half_adder_0/b]
  connect_bd_net -net half_adder_0_carry [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins half_adder_0/carry]
  connect_bd_net -net half_adder_0_sum [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins half_adder_0/sum]
